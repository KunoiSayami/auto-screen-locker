        ...
        binding.tvStatus.text = when {
            ...
            serviceEnabled -> {
                ...
                buildString {
                    ...
                    val appListMode = Prefs.appListMode(this@MainActivity)
                    if (appListMode != AppListMode.OFF) {
                        val count = Prefs.appListPackages(this@MainActivity).size
                        append("\n${getString(R.string.status_app_list, getString(when (appListMode) {
                            AppListMode.BLACKLIST -> R.string.app_list_mode_blacklist
                            AppListMode.WHITELIST -> R.string.app_list_mode_whitelist
                            AppListMode.OFF -> R.string.app_list_mode_off
                        }), count)}")
                    }
                    if (lastLockStr != null) {
